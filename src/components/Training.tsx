...
const PROGRAMS = [
  ...
  },
  {
    ...
    gradient: "from-[#1B4332] to-[#75c402]",
  },
  {
...
export default function Training() {
  return (
    <section id="training" className="py-16 md:py-28 bg-[#F5F7F5]">
      <div className="max-w-8xl mx-auto px-6 md:px-8">
        ...
        <div className="text-center mb-12 reveal opacity-0">
          ...
          <h2 className="text-[clamp(28px,4vw,44px)] font-extrabold leading-[1.18] tracking-[-0.02em] text-[#0D0D0D] mb-5">
            Advanced Training.{" "}
            <span className="text-phyto-bright">Practical Expertise.</span>
          </h2>
          <p className="text-[17px] text-[#5A6560] max-w-[620px] mx-auto leading-relaxed">
            Specialized training programs for researchers, students and industry
            professionals.
          </p>
        </div>
        ...
        <div className="text-center reveal opacity-0">
          <Link
            href="/training"
            className="inline-flex items-center justify-center bg-transparent text-phyto-bright text-[15px] font-semibold px-8 py-3.5 rounded-full border-2 border-phyto-forest hover:bg-phyto-forest hover:text-white hover:-translate-y-px hover:shadow-md transition-all duration-[280ms]"
          >
